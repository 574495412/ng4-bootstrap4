...
@Component({
  selector: 'app-ticketdatails',
  templateUrl: './ticketdatails.component.html',
  styleUrls: ['./ticketdatails.component.css']
})
export class TicketDatailsComponent implements OnInit {
